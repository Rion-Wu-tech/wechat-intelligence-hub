...
- [一个产品，两个 Skill](#一个产品两个-skill)
- [安装](#安装)
  - [直接让 Codex 安装和配置](#直接让-codex-安装和配置)
  - [手动安装入口](#手动安装入口)
- [在 Codex 中怎么使用](#在-codex-中怎么使用)
  - [完整日报同时输出 Markdown 和 HTML](#完整日报同时输出-markdown-和-html)
- [隐私与安全](#隐私与安全)
- [付费社群](#付费社群ai-实践与商业化-club)
- [AI 指导、企业培训、定制与商务合作](#ai-指导企业培训定制与商务合作单独收费)
- [支持这个项目](#支持这个项目--support-the-project)
- [License](#license)
